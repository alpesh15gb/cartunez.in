    ...
    <section className="relative bg-gradient-to-b from-white to-gray-50 text-gray-900 py-24 sm:py-28 border-t border-gray-100">
      ...
      <div className="content-container relative z-10">
        ...
        <div className="text-center max-w-xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-sm text-gray-500 font-medium leading-relaxed max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
          {reels.slice(0, 8).map((reel) => (
            <div
              ...
              className="group relative aspect-[9/16] rounded-[var(--radius-md)] overflow-hidden cursor-pointer
                         shadow-md hover:shadow-[var(--shadow-xl)]
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-black/10
                              ...
                              flex flex-col justify-between p-4 sm:p-5 z-10">
                
                {/* Instagram badge */}
                <div className="self-end">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full
                                  bg-white/10 backdrop-blur-sm border border-white/20
                                  text-white opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="space-y-3">
                  ...
                  {/* Caption */}
                  {reel.caption && (
                    <p className="text-[10px] text-gray-200/90 line-clamp-2 text-center leading-relaxed font-medium">
                      {reel.caption}
                    </p>
                  )}
                </div>
      ...
      {activeReel && (
        <div
          ...
          onKeyDown={(e) => { if (e.key === "Escape") setActiveReel(null); }}
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          >
            <button
              onClick={() => setActiveReel(null)}
              className="absolute -top-12 right-0 text-white/60 hover:text-white transition-colors duration-300 flex items-center gap-2 text-xs font-medium"
            >
              <span>Close</span>
              <X size={16} />
            </button>
